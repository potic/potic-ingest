...
docker run -dit --name potic-ingest --link potic-pocket-api -e LOG_PATH=/logs -v /logs:/logs -e MONGO_PASSWORD=$MONGO_PASSWORD -p 40404:8080 potic/potic-ingest:$TAG_TO_DEPLOY
